...
impl TokenKind {
    ...
    pub fn get_name(&self) -> String {
        match self {
            ...
            TokenKind::RightAngleBracket => "Right Angle Bracket",
            ...
            TokenKind::LessThanEqualSign => "Less Than Equal Sign",
            TokenKind::GreaterThanEqualSign => "Greater Than Equal Sign",
    ...
    pub fn get_length(&self) -> usize {
        match self {
            ...
            TokenKind::LeftAngleBracket => 1,
            TokenKind::RightAngleBracket => 2,
            TokenKind::Plus => 1,
            TokenKind::Minus => 1,
            TokenKind::Star => 1,
            TokenKind::Slash => 1,
            ...
            TokenKind::LessThanEqualSign => 2,
            TokenKind::GreaterThanEqualSign => 2,
            TokenKind::Comma => 1,
            TokenKind::Colon => 1,
    ...
    pub fn get_classification(&self) -> Classification {
        match self {
            ...
            TokenKind::LeftAngleBracket => Classification::Punctuation("<".to_owned()),
            TokenKind::RightAngleBracket => Classification::Punctuation(">".to_owned()),
            ...
            TokenKind::LessThanEqualSign => Classification::Punctuation("<=".to_owned()),
            TokenKind::GreaterThanEqualSign => Classification::Punctuation(">=".to_owned()),
